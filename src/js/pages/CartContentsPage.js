    ...
    return (
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.cart_footer}>
          ...
          <Button buttonStyle={styles.checkout_button} containerStyle={styles.checkout_button_container} onPress={() => {this.props.navigation.navigate('InventoryList');}} title="CHECKOUT"/>
        </View>
      </ScrollView>
      </ThemeProvider>
    );
