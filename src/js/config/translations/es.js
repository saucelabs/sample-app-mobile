export default {
	...
	'geoLocation':{
		...
		'this':' esta ',
		'link':'enlace.',
		'determinePosition': 'Determinar la ubicación de Android puede llevar tiempo.',
		'errorSettings': 'No se puede abrir la configuración',
		'locationPermission': 'Location permission denied',
		'enableLocation': 'Permiso de ubicación denegado',
		'toSettings': 'Ir a la configuración.',
		'dontUse':'No uses la ubicación.',
		'deniedByUser': 'Permiso de ubicación denegado por la usuaria.',
		'position': 'Determinar ubicación...',
		'latitude': 'latitud',
		'longitude': 'longitud',
	},
	'appHeader': {
